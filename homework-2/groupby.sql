...
SELECT country FROM customers WHERE country IN (SELECT country FROM suppliers)
...
SELECT country FROM customers WHERE country IN (SELECT country FROM suppliers)
AND country NOT IN (SELECT country FROM employees WHERE country IS NOT NULL);